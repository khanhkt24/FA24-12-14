...
<body>
            ...
            <div class="col-lg-3 d-none d-lg-block">
                <a href="" class="text-decoration-none">
                    <h1 class="m-0 display-5 font-weight-semi-bold"><span
                            class="text-primary font-weight-bold border px-3 mr-1">C</span>LEO</h1>
                </a>
            </div>
        ...
        <div class="row border-top px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a class="btn shadow-none d-flex align-items-center justify-content-between bg-primary text-white w-100"
                    data-bs-toggle="collapse" href="#navbar-vertical" style="height: 65px; padding: 0 30px;">
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ml-auto py-0">
                            @if (auth('cus')->check())
                                <a href="{{ route('client.profile') }}" class="nav-item nav-link">Hi,
                                    {{ auth('cus')->user()->name }}</a>
                        ...
                        <div class="carousel-item active" style="height: 410px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">Giảm 10% sản phẩm
                                    </h4>
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">Áo thời trang nữ</h3>
                        ...
                        <div class="carousel-item" style="height: 410px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    ...
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">Quần thời trang nữ</h3>
                                    <a href="" class="btn btn-light py-2 px-3">Mua ngay</a>
                                </div>
                            </div>
                        </div>
    ...
    <!-- Featured Start -->
    @include('Client.layouts.patials.featured')
    ...
    @include('Client.layouts.patials.js-client')
