...
@section('content')
    <style>
        .input-disabled {
            ...
            /* Màu nền giống như input disabled */
            border: 1px solid #ddd;
            /* Viền nhẹ */
            color: #aaa;
            /* Màu chữ nhạt đi */
            pointer-events: none;
            /* Không cho phép tương tác với input */
            cursor: not-allowed;
            /* Con trỏ chuột thay đổi thành dấu không cho phép */
        }
    </style>
    <!-- Page Header Start -->
                    ...
                    <div class="myaccount-content mb-4">
                        ...
                        <div class="myaccount-content">
                            ...
                            <div class="myaccount-table table-responsive text-center">
                                ...
                                @if ($orders->giaohang == \App\Models\Order::TYPE_0)
                                    <!-- Đang xác nhận -->
                                    <td>
                                        <form action="{{ route('order.cancel1', $orders->id) }}" method="POST">
                                            ...
                                            <button class="btn btn-danger"
                                                onclick="return confirm('Bạn có muốn hủy đơn hàng này không?');">Hủy</button>
                                        </form>
                                    </td>
                                @else
                                    <td>Không thể hủy</td>
