                ...
                <form>
                    @foreach($product->bienthe as $index => $bienthes)
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="size-{{ $index }}" name="size" value="{{ $bienthes->size }}">
            ...
            <div class="d-flex mb-4">
                ...
                <form>
                    @foreach($product->bienthe as $index => $bienthess)
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="color-{{ $index }}" name="color" value="{{ $bienthess->color }}">
