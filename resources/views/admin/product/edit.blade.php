                        ...
                        <div class="mt-3 mb-4">
                            ...
                            @if (!empty($product->img))
                                <div style="width: 100px; height: 100px;">
                                    <img src="{{ Storage::url($product->img) }}" style="max-width: 100%; max-height: 100%"
                                        alt="">
                                </div>
                            @endif
                            @error('img')
                        ...
                        <div class="mt-3 mb-4">
                            ...
                            <select name="tag_id" id="" class="form-select">
                                @foreach ($tag as $id => $name)
                                    <option value="{{ $id }}" @selected($product->tag_id == $id)>{{ $name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mt-3 mb-4">
                            ...
                            <select name="category_id" id="" class="form-select">
                                @foreach ($category as $id => $name)
                                    <option value="{{ $id }}" @selected($product->category_id == $id)>{{ $name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
